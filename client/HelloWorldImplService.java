 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server/", wsdlLocation = "http://serverJava:8080/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://serverJava:8080/WS/HelloWorld?wsdl");
